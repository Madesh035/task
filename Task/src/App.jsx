    ...
    <div className="relative min-h-screen font-sans overflow-hidden text-white scroll-smooth transition-all duration-500 ease-in-out">
      ...
      <div className="relative z-10">
        ...
        <nav className="flex justify-center items-center px-8 py-4 border-b border-white/10 bg-white/10 backdrop-blur-md shadow-md">
          <ul className="flex space-x-6 text-sm text-white/80 font-medium transition-all duration-300">
            {["home", "about", "skills", "projects", "certifications", "contact"].map((section) => (
              <li
                key={section}
                onClick={() => setActiveSection(section)}
                className={`hover:text-white cursor-pointer capitalize transition duration-300 ${
        ...
        {/* Home */}
        {activeSection === "home" && (
          <section className="flex flex-col items-center justify-center text-center px-10 py-20 gap-10 transition-all duration-500">
            ...
            <div data-aos="fade-up">
              <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-4">
                I’m <span className="text-yellow-300">Madesh G</span>
              </h1>
        ...
        {activeSection === "about" && (
          <>
            <section className="px-10 py-10 text-center" data-aos="fade-up">
              <h2 className="text-3xl font-bold mb-4 text-yellow-300">Objective</h2>
            ...
            <section className="px-10 py-10" data-aos="fade-up">
              <h2 className="text-3xl font-bold text-center text-yellow-300 mb-8">Education</h2>
        ...
        {activeSection === "skills" && (
          <section className="px-10 py-10" data-aos="fade-up">
            <h2 className="text-3xl font-bold text-center text-yellow-300 mb-8">Skills</h2>
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 text-slate-100">
              <div>
        ...
        {activeSection === "projects" && (
          <section className="px-10 py-10" data-aos="fade-up">
            <h2 className="text-3xl font-bold text-center text-yellow-300 mb-6">Project</h2>
        ...
        {activeSection === "certifications" && (
          <>
            <section className="px-10 py-10" data-aos="fade-up">
              <h2 className="text-3xl font-bold text-center text-yellow-300 mb-6">Certifications</h2>
              <ul className="max-w-3xl mx-auto list-disc list-inside text-slate-200">
            ...
            <section className="px-10 py-10" data-aos="fade-up">
              <h2 className="text-3xl font-bold text-center text-yellow-300 mb-6">More About Me</h2>
              <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 text-slate-100">
                <div>
        ...
        {activeSection === "contact" && (
          <section className="px-10 py-10 text-center" data-aos="fade-up">
            <h2 className="text-3xl font-bold text-yellow-300 mb-4">Contact</h2>
            <p className="text-white text-lg">
              Email: <a href="mailto:madesh51342@gmail.com" className="text-blue-300 hover:underline">madesh51342@gmail.com</a>
            </p>
            <p className="text-white text-lg mt-2">Phone: <span className="text-blue-300">6374569160</span></p>
            <div className="flex justify-center mt-4 space-x-6 text-lg">
              <a href="https://github.com/Madesh035" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-300">GitHub</a>
              <a href="https://www.linkedin.com/in/madesh-madesh-167533254/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-300">LinkedIn</a>
            </div>
          </section>
        )}
      </div>
